...
var App = React.createClass({
  ...
  render: function() {
      ...
      JQueryMobilePage({ id: 'entryPost' }, EntryPostContent(null))
    );
  }
});
...
/** Application page login component. */
var EntryPostContent = React.createClass({
    displayName: 'EntryPostContent',

    render: function () {
        return React.DOM.form({ "id": "entry-post-form", "class": "ui-body ui-body-a ui-corner-all", "data-ajax": "false" },
          React.DOM.fieldset(null,
            React.DOM.div({ "data-role": "fieldcontain" },
                React.DOM.label({ "for": "title" }, "Title:"),
                React.DOM.input({ "type": "text", "name": "title", "id": "title", placeholder: "" })),
          React.DOM.div({ "data-role": "fieldcontain" },
                React.DOM.label({ "for": "body" }, "Context:"),
                React.DOM.input({ "type": "text", "name": "body", "id": "body" })),
            React.DOM.input({ "type": "button", "data-theme": "b", name: "submit", id: "post-new-submit", value: "Submit" }))
        );
...
EntryPostContent = React.createFactory(EntryPostContent);
...
var sessionsContent = React.createClass({
    ...
    render: function () {
        return React.DOM.div(null,          
          React.DOM.a({ 'id': 'post-new-btn', 'data-role': 'button' }, 'Post new'),
